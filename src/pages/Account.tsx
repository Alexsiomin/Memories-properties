...
// Compact logo mark, mirrored from Masthead/AuthModal's monogram — drawn
// inline so it inherits color via currentColor without an external asset.
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-foreground/40 backdrop-blur-sm" onClick={() => setShowSignOut(false)}>
          ...
          >
            <div className="flex flex-col items-center justify-center text-center">
              <MonogramIcon className="h-10 w-auto text-[#00101f]" />
              <p className="mt-3 font-montserrat font-extrabold uppercase tracking-[0.12em] text-lg text-[#00101f]">
                Memories
              </p>
